...
public class CustomDTO {
	...
	public String toString() {
		return "CustomDTO [busi_num=" + busi_num + ", custom=" + custom + ", short_=" + short_ + ", ceo=" + ceo
				...
				+ special_relation + ", trade_stop=" + trade_stop + ", regi_info_man=" + regi_info_man
				+ ", regi_info_date=" + regi_info_date + ", modi_info_man=" + modi_info_man + ", modi_info_date="
				+ modi_info_date + ", factory=" + factory + ", trade_bank=" + trade_bank + ", account_num="
				+ account_num + "]";
	}
